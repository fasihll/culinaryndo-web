...
module.exports = {
	async up(queryInterface, Sequelize) {
		...
		await queryInterface.bulkInsert(
			...
			[
				{
					image: 'https://i.imgur.com/COAGwrJ.jpg',
					title: 'Soto',
				...
				{
					image: 'https://i.imgur.com/3sMbuw2.jpg',
					title: 'Sate',
				...
				{
					image: 'https://i.imgur.com/dNAXd03.jpg',
					title: 'Rendang',
				...
				{
					image: 'https://i.imgur.com/ldzQ97q.jpg',
					title: 'Rawon',
				...
				{
					image: 'https://i.imgur.com/etIaaO3.jpg',
					title: 'Pempek',
				...
				{
					image: 'https://i.imgur.com/FPoKOTP.jpg',
					title: 'Nasi Goreng',
				...
				{
					image: 'https://i.imgur.com/jj4rH3Y.jpg',
					title: 'Gudeg',
				...
				{
					image: 'https://i.imgur.com/wVByqaX.jpg',
					title: 'Gado Gado',
				...
				{
					image: 'https://i.imgur.com/1BxvQpL.jpg',
					title: 'Bebek Betutu',
				...
				{
					image: 'https://i.imgur.com/I0QJ1Na.jpg',
					title: 'Bakso',
